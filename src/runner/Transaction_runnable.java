...
public class Transaction_runnable extends HttpServlet {
		...
		while (choice !=8) {
			try{
				...
				case 3:
					...
					String format3= "\n%-18s %-18s  \n";
					System.out.format (format3, "# of Transactions" , "Total Transaction Value"); 
					System.out.format( format3, mytransaction3.getCount(), "$" +mytransaction3.getValue() );
